...
const getToastColor = (toastType: string | undefined) => {
  return toastType ? COLORS[toastType] : COLORS.info
}

const getToastStyles = (color: { border: string; dot: string }) => ({
  position: 'fixed',
  top: '72px',
  left: '50%',
...
export default function Toast() {
  ...
  const styles = getToastStyles(color)
    ...
    <AnimatePresence>
      {toast && (
        ...
        >
          ...
          {/* message */}
          <span style={{ fontFamily: 'var(--font-geist-sans)', fontSize: '13px', color: '#E5E5E5', lineHeight: 1.4, flex: 1, }} >
            {toast.message}
          </span>
          {/* dismiss */}
