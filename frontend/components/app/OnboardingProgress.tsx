...
const getStepStatus = (props: OnboardingProgressProps, step: typeof STEPS[number]) => {
  const completed = props[step.key]
  const dotColor = completed ? '#E50914' : '#2a2a2a'
  return { completed, dotColor }
}

const getActiveIndex = (props: OnboardingProgressProps) => {
  return STEPS.findIndex((s) => !props[s.key])
}
  ...
  return (
    ...
    >
      ...
      <div className="flex items-start justify-between gap-2 relative">
        ...
        />
        {STEPS.map((step, i) => {
          const { completed, dotColor } = getStepStatus(props, step)
            ...
            >
              <motion.div
                ...
                style={{
                  ...
                  height: '14px',
                  borderRadius: '50%',
                  background: completed ? '#E50914' : '#0f0f0f',
              ...
              <div className="flex flex-col items-center gap-0.5 text-center">
                <span
                  style={{
                    fontFamily: 'var(--font-geist-sans)',
                    color: completed ? '#fff' : active ? '#E50914' : '#525252',
                    fontSize: '10px',
