...
const getCompletedStatus = (props: OnboardingProgressProps, key: typeof STEPS[number]['key']) => props[key];
const getActiveIndex = (props: OnboardingProgressProps) => STEPS.findIndex((s) => !getCompletedStatus(props, s.key));
const getAllDone = (props: OnboardingProgressProps) => STEPS.every((s) => getCompletedStatus(props, s.key));

export default function OnboardingProgress(props: OnboardingProgressProps) {
  const allDone = getAllDone(props);
