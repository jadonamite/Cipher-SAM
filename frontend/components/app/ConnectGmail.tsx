...
const renderCompactButton = (handleConnect: () => void) => (
  <motion.button
...
const renderFullComponent = (handleConnect: () => void) => (
  <motion.div
...
export default function ConnectGmail({ compact = false }: ConnectGmailProps) {
  ...
  if (compact) {
    return renderCompactButton(handleConnect)
  }

  return renderFullComponent(handleConnect)
}
